...
public class NamedEntityQueryParser implements QueryParser {

    public static final String NAME = "namedentity";

    @Inject
    public NamedEntityQueryParser() {
    }
	...
	public Query parse(QueryParseContext parseContext) throws IOException, QueryParsingException {
        ...
        NamedEntityQuery multiMatchQuery = new NamedEntityQuery(parseContext);
