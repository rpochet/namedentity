...
public class NamedEntityTokenFilter2 extends TokenFilter {

	private static final ESLogger Logger = ESLoggerFactory
			.getLogger(NamedEntityTokenFilter2.class.getName());
	...
	/**
	 * The default index name containing named entity search terms to convert a shingle
	 */
	public static final String DEFAULT_NAMEDENTITY_INDEX = "namedentity";
	...
	/**
	 * Constructs a NamedEntityTokenFilter with the specified shingle size from the
	 ...
	 */
	public NamedEntityTokenFilter2(TokenStream input, int minShingleSize, int maxShingleSize) {
		super(input);
	...
	public void setNamedEntityIndex(String namedEntityIndex) {
	...
	public void setFillerToken(String fillerToken) {
		this.fillerToken = null == fillerToken ? new char[0] : fillerToken
				.toCharArray();
	}
	...
	public final boolean incrementToken() throws IOException {
		...
		if (inputWindow.size() >= gramSize.getValue()) {
			...
			if (!isAllFiller && builtGramSize == gramSize.getValue()) { // 1 or maxShingleSize
